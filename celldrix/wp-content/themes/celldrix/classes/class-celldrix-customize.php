...
if ( ! class_exists( 'celldrix_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	
	 */
	class celldrix_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'celldrix' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'celldrix' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'celldrix' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'celldrix' ),
						'full'    => esc_html__( 'Full text', 'celldrix' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-celldrix-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'celldrix_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new celldrix_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'celldrix' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
